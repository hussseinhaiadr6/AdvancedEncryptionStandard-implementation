...
string RandomKeyGenrator(int key_size){
  ...
  // here we are definety an array of U_int8  which is going to be of size 16 
  ...
  {
    // set f  ill will add a padding of 0 example if the byte resulted in 0d as hex ouptut wihtout this I/O maipulator 
